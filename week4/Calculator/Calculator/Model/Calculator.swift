...
struct Calculator {
    ...
    mutating func percent() {
        percentOrToggleDisplayNumber(isToggle: false)
    }
    
    mutating func toggleDisplayNumber() {
        percentOrToggleDisplayNumber(isToggle: true)
    }
    
    private mutating func percentOrToggleDisplayNumber(isToggle: Bool) {
        guard let calculationResult = calculationResult else {
            return
        }
